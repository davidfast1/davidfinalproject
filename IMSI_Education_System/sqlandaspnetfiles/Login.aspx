...
<body>
    <form id="LoginForm" runat="server">
        <asp:TextBox ID="EmpPassTextbox" runat="server" style="z-index: 1; left: 192px; top: 140px; position: absolute; width: 80px; margin-top: 12px;"></asp:TextBox>
        ...
        <asp:TextBox ID="ManPassTextbox" runat="server" style="z-index: 1; left: 545px; top: 157px; position: absolute; width: 80px"></asp:TextBox>
        ...
        <asp:TextBox ID="HRPassTextbox" runat="server" style="z-index: 1; left: 925px; top: 156px; position: absolute; width: 80px"></asp:TextBox>
        ...
        <asp:TextBox ID="AudPassTextbox" runat="server" style="z-index: 1; left: 1252px; top: 162px; position: absolute; width: 80px"></asp:TextBox>
