...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="LogoutButton" runat="server" style="z-index: 1; left: 95px; top: 20px; position: absolute; width: 90px;" Text="Logout" OnClick="LogoutButton_Click" />
        <p>
            <asp:Label ID="NewLogError" runat="server" style="z-index: 1; left: 500px; top: 35px; position: absolute; height: 19px;" Text="Enter all fields for a new log."></asp:Label>
