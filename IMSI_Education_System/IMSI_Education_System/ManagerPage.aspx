...
where Assignment.EmployeeID = Employee.EmployeeID and Assignment.QuizID = Quiz.QuizID"></asp:SqlDataSource>
            ...
            <asp:Button ID="LogoutButton" runat="server" style="z-index: 1; left: 50px; top: 30px; position: absolute; width: 90px;" Text="Logout" OnClick="LogoutButton_Click" />

            <p>
                <asp:Label ID="Reminder" runat="server" style="z-index: 1; left: 1000px; top: 100px; position: absolute" Text="Something is empty; please change it!"></asp:Label>
